"""
In order to test updating the schedule, you have to run the whole thing.
"""
...
from modules.core.source import attach_core_module, bot
from modules.core.permanent import DATABASE_FOLDER, DATABASE_NAME
from modules.autoparser import permanent, controller
...
class TestUpdateSchedule(unittest.TestCase):
    """
    Copy-past of inner funtction parse_new_timetable in order to test it
    """
